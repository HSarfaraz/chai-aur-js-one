  ...
  <div>
    ...
    <h1>
      ...
      **Example:**
      ...
      // we can select the input slector as well document.querySlector(input); //we can select the attribute as well
      document.querySelector('input[type="password"]')
      //select 1st child of paragraph document.querySelector('p:first-child');
      ...
      **Example:**
      ...
      ```
      - Remember, querySelector will only
      ...
      - In querySelectorAll, it is important to know what datatype it is returning - Scenario: We need to
      apply class on each element of list
      - **Array.from():** This method will convert nodelist into the array
      - ```javascript const tempClassList =
